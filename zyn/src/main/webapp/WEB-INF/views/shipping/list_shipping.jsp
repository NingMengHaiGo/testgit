				...
				<table class="table table-hover" id="show_productMsg">
					...
					<c:forEach items="${shippingList.getList()}" var="shippingList">
						...
						<tr>
							...
							收件人固定电话：${shippingList.receiverPhone }
							...
							<th>
								...
								<!-- <button class="btn btn-info btn-sm">
									<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span><a href="">
									编辑</a>
								</button> -->
								
								<button  class="btn btn-danger btn-sm">
									<span class="glyphicon glyphicon-trash" aria-hidden="true"></span><a href="delete?shippingId=${shippingList.id}">
									删除</a>
								</button>
